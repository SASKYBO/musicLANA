...
ARQ_API_KEY = "VPEROE-SCEKFN-APHXJA-KYUJLY-ARQ"
    ...
    if replied:
        if replied.audio or replied.voice:
            ...
            if chat_id in QUEUE:
                ...
                await m.reply_photo(
                    photo="https://telegra.ph/file/06fb52da792f8485d3fcc.jpg",
                    caption=f"""
...
async def playlist(client, m: Message):
    ...
    if chat_id in QUEUE:
        ...
        await m.reply("**لا يوجد هناك شئ للتشغيل .**")
...
async def skip(client, m: Message):
    ...
    if len(m.command) < 2:
        ...
        if op == 0:
            ...
            await m.reply("قائمة الانتظار فارغه ، تم مغادرة المكالمه**")
        else:
